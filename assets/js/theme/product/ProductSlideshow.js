...
export default class ProductSlideshow {
  constructor($scope, context) {
    ...
    this.imgLoad = imagesLoaded(this.context);

    this.imgLoad.on('progress', () => this._slideHeight());
    this.imgLoad.on('always', () => this._setupSlides(), setTimeout(() => {this._slidesHeight();}, 500));
  ...
  _slidesHeight() {
    imagesLoaded($('.flickity-viewport'), () => {
